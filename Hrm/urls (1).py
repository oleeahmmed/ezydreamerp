...
from .views.zk_device_views import (
    ...
    ZKDeviceDetailView, ZKDeviceDeleteView,ZKDeviceExportView,ZKDeviceBulkDeleteView, ZKDeviceConnectionTestView,
    ZKDeviceSyncView, ZKAttendanceLogListView, ZKDeviceSaveDataView, ZKUserListView, ZKUserInsertView, ZKUserSyncView, ZKUserSimpleListView, ZKUserSaveView,ZKAttendanceLogBulkDeleteView,ZKAttendanceLogDeleteView,
)
app_name = 'hrm'
...
urlpatterns = [
    ...
    path('device-sync/', ZKDeviceSyncView.as_view(), name='zk_device_sync'),
]