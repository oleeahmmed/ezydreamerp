...
from ..forms.zk_device_forms import ZKUserFilterForm, ZKUserForm
...
class ZKUserDeviceListView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'list_url': reverse_lazy('hrm:zk_user_list'),
            'print_url': '#',
        })
        return context
...
class ZKUserAddView(LoginRequiredMixin, PermissionRequiredMixin, FormView):
        ...
        context.update(
            {
                ...
                "zk_available": ZK_AVAILABLE,
                "cancel_url": reverse_lazy("hrm:zk_user_list"),
            }
        )
        return context
    ...
    def get_success_url(self):
        return reverse_lazy("hrm:zk_user_list")
...
class ZKUserDeleteView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        if not ZK_AVAILABLE:
            ...
            return HttpResponseRedirect(reverse_lazy('hrm:zk_user_list'))
