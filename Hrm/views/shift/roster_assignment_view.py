...
from Hrm.models import RosterAssignment, RosterDay
from Hrm.forms import RosterAssignmentForm, RosterDayFormSet, RosterAssignmentFilterForm
...
class RosterAssignmentCreateView(CreateView):
    ...
    template_name = 'roster/formset-form.html'
