...
class InventoryHasDynamicModelPermission(permissions.BasePermission):
    """
    ...
    def has_permission(self, request, view):
        ...
        required_permission = f'Inventory.{perm_action}_{model_name}'
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS:
            perm_action = 'view'
        elif request.method in ['PUT', 'PATCH']:  # Added PATCH here
            perm_action = 'change'
        elif request.method == 'DELETE':
            perm_action = 'delete'
        else:
